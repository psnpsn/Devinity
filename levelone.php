...
<div class="play">
	...
	<input type="text" name="number" class="numberText" id="number" maxlength="2" onkeypress="return onlyNumber(event)" placeholder="00">
...
<script type="text/javascript">	
	...
	function sendValue(){
			var xhr=createXHR();
				...
				xhr.open("GET","attempts.php?value="+nattempts+"&level=one",true);
				xhr.send();
	}
