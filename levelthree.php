...
<div class="play">
	...
	<input type="text" name="number" class="numberText" id="number" maxlength="4" onkeypress="return onlyNumber(event)" placeholder="0000">
...
<script type="text/javascript">	
	...
	function sendValue(){
			var xhr=createXHR();
				...
				xhr.open("GET","attempts.php?value="+nattempts+"&level=three",true);
				xhr.send();
	}
